...
map.getView().fit([11775565.162541, 2067131.465059, 11803860.895936, 2081015.529112], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Bản đồ ngập lụt hạ du hồ Kẻ Gỗ</h2>';
        return titleElement;
    })(),
